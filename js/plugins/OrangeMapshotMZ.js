...
(function ($) {
    ...
    $.Param.fullDebug = $.Parameters.fullDebug !== "false";
    $.Param.autoCaptureMode = $.Parameters.autoCaptureMode !== "false";
    $.Param.commandDebugMode = $.Parameters.commandDebugMode !== "false";
    ...
    $.saveFullDebugScreenshots = function () {
        ...
        try {
            ...
            fs.mkdir(path, { recursive: true }, function (err) {
                ...
                const _Scene_Map_onMapLoaded = SceneManager._scene.constructor.prototype.onMapLoaded;
                var pendingScreenshots = [];
                var isProcessing = false;

                SceneManager._scene.constructor.prototype.onMapLoaded = function () {
                        ...
                        setTimeout(function () {
                            try {
                                ...
                                var callback = function (error) {
                                    ...
                                    // Trigger next transfer after screenshot is saved
                                    isProcessing = false;
                                    processNextCoordinate();
                                };
