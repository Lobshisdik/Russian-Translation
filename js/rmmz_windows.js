...
Window_MenuCommand.prototype.addOptionsCommand = function() {
    if (this.needsCommand("options")) {
        ...
        this.addCommand(TextManager.options, "options", enabled, 83);
    }
};
...
Window_MenuCommand.prototype.addGameEndCommand = function() {
    ...
    this.addCommand(TextManager.gameEnd, "gameEnd", enabled, 189);
};
...
Window_BattleSkill.prototype.initialize = function(rect) {
    ...
    const height = Graphics.boxHeight-410;
    const x = 0;
    const y = 310;
    const newRect = new Rectangle(x, y, width, height);
    Window_SkillList.prototype.initialize.call(this, newRect);
    this.opacity = 192; // Semi-transparent (255 is full opaque, 0 is fully transparent)
    this.hide();
};
...
Window_BattleItem.prototype.initialize = function(rect) {
    ...
    Window_ItemList.prototype.initialize.call(this, newRect);
    this.opacity = 192; // Semi-transparent
...
Window_SkillList.prototype.itemHeight = function() {
    return 36; // smaller height per item (default is 48)
};
...
Window_SkillList.prototype.drawItem = function(index) {
    ...
    if (skill) {
        ...
        const rect = this.itemLineRect(index);
        this.resetTextColor();
        this.contents.fontSize = 20; // set smaller font size
        this.drawItemName(skill, rect.x, rect.y, rect.width - costWidth);
        this.drawSkillCost(skill, rect.x, rect.y, rect.width);
    }
};
...
Window_ItemList.prototype.itemHeight = function() {
    return 36; // smaller height per item
};
...
Window_ItemList.prototype.drawItem = function(index) {
    ...
    if (item) {
        ...
        this.changePaintOpacity(this.isEnabled(item));
        this.resetTextColor();
        this.contents.fontSize = 18; // set smaller font size
        this.drawItemName(item, rect.x, rect.y, rect.width - numberWidth);
        this.drawItemNumber(item, rect.x, rect.y, rect.width);
        this.changePaintOpacity(true);
    }
